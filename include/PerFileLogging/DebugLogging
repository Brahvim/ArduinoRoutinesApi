...
/** @brief Logs whatever is passed, as a `PROGMEM`-string. */
...
/** @brief Logs whatever is passed, with a new-line at the end, as a `PROGMEM`-string. */
#define DEBUG_PRINT_NOPRE_LN(string)            \
Serial.println(F(string))
#pragma endregion

#pragma region // Logging with a prefix.
/** @brief Logs with the prefix. */
#define DEBUG_PRINT_NOPM(...)                   \
    Serial.print(DEBUG_LOGS_PREFIX);            \
    Serial.print(__VA_ARGS__)

/** @brief Logs with the prefix, as a `PROGMEM`-string. */
...
/** @brief Logs with the prefix, and a new-line at the end, as a `PROGMEM`-string. */
